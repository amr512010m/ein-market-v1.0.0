...
var images = ['whiter.webp','realme.jpeg','special-tag.png','fo.jpg','letter-e.png'];
...
i = 0;
 ...
 var v2=document.getElementById('alert280');
 var v1=document.getElementById('alert100');
 var ai=document.getElementById('ai');
 var vbn=document.getElementById('vbn');
vbn.onmouseover=function(){v2.style.display='block';v1.style.display='none';}
ai.onmouseover=function(){v2.style.display='none';v1.style.display='block';}
vbn.onmouseout=function(){v2.style.display='none';}
ai.onmouseout=function(){v1.style.display='none';}
...
search.onclick=function(){var research =prompt('what are you looking for'); 
      if(research=='monitors'){ console.log( 'you searched about monitors');mobi.style.display='none'; lap.style.display='none';iphone.style.display='none';
                         ...
                         else if(research=='food'||resarch=='FOOD'||research=='Food '||research==' Food '||research==' Food   '||research=='F ood '||research=='Food'){mobi.style.display='block'; lap.style.display='none';iphone.style.display='none';
...
setTimeout(function(){	i=i-1},150);
setTimeout(function(){	i=i+1},150);
setTimeout(function(){	i=i+1},150);setTimeout(function(){	i=i+1},150);setTimeout(function(){	i=i+1},150);setTimeout(function(){	i=i+1},150);setTimeout(function(){	i=i+1},150);setTimeout(function(){	i=i+1},150);setTimeout(function(){	i=i+1},150);setTimeout(function(){	i=i+1},150);setTimeout(function(){	i=i+1},150);setTimeout(function(){	i=i+1},150);setTimeout(function(){	i=i+1},150);setTimeout(function(){	i=i+1},150);setTimeout(function(){	i=i+1},150);setTimeout(function(){	i=i+1},150)
